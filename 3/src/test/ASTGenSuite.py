...
class ASTGenSuite(unittest.TestCase):
    ...
    def test_simple_program(self):
        """Simple program"""
        input = """a: array[10,10] of integer;
        """
        expect = """Program([
...
#         self.assertTrue(TestAST.test(input, expect, 344))
    ...
    def test_simple_program45(self):
        ...
        expect = """Program([
	FuncDecl(main, VoidType, [], None, BlockStmt([CallStmt(foo, BinExpr(+, IntegerLit(2), Id(x)), BinExpr(/, FloatLit(4.0), Id(y))), CallStmt(goo, ), ForStmt(AssignStmt(Id(i), IntegerLit(1)), BinExpr(<=, Id(i), BinExpr(/, BinExpr(*, Id(n), BinExpr(+, Id(n), IntegerLit(1))), IntegerLit(2))), BinExpr(+, Id(i), IntegerLit(1)), BlockStmt([CallStmt(printf, StringLit(%d ), Id(i)), IfStmt(BinExpr(==, Id(i), BinExpr(/, BinExpr(*, Id(j), BinExpr(+, Id(j), IntegerLit(1))), IntegerLit(2))), BlockStmt([CallStmt(printf, StringLit(\\b\\n)), AssignStmt(Id(j), BinExpr(+, Id(j), IntegerLit(1)))]))]))]))
])"""
...
#
    ...
    """
        expect = """Program([
	FuncDecl(main, IntegerType, [], None, BlockStmt([VarDecl(n, IntegerType), AssignStmt(Id(n), FuncCall(readInteger, [])), IfStmt(BinExpr(==, Id(n), IntegerLit(0)), ReturnStmt(IntegerLit(1)), ReturnStmt(BinExpr(*, Id(n), FuncCall(fact, [BinExpr(-, Id(n), IntegerLit(1))]))))]))
	FuncDecl(inc, VoidType, [Param(n, IntegerType), Param(delta, IntegerType)], None, BlockStmt([AssignStmt(Id(n), BinExpr(+, Id(n), Id(delta))), VarDecl(check, BooleanType, BooleanLit(False)), IfStmt(BinExpr(>, Id(n), BinExpr(&&, IntegerLit(3), BinExpr(<, Id(delta), IntegerLit(3)))), AssignStmt(Id(check), BooleanLit(True))), WhileStmt(BinExpr(>, Id(n), BinExpr(&&, IntegerLit(3), BinExpr(<, Id(delta), IntegerLit(3)))), BlockStmt([CallStmt(printInteger, Id(n)), AssignStmt(Id(delta), BinExpr(+, Id(delta), IntegerLit(4)))]))]))
])"""
    ...
    """
        expect = """Program([
	FuncDecl(main, IntegerType, [], None, BlockStmt([VarDecl(n, IntegerType), AssignStmt(Id(n), FuncCall(readInteger, [])), IfStmt(BinExpr(==, Id(n), IntegerLit(0)), ReturnStmt(IntegerLit(1)), ReturnStmt(BinExpr(*, Id(n), FuncCall(fact, [BinExpr(-, Id(n), IntegerLit(1))]))))]))
	FuncDecl(inc, VoidType, [Param(n, IntegerType), Param(delta, IntegerType)], None, BlockStmt([AssignStmt(Id(n), BinExpr(+, Id(n), Id(delta))), VarDecl(check, BooleanType, BooleanLit(False)), IfStmt(BinExpr(>, Id(n), BinExpr(&&, IntegerLit(3), BinExpr(<, Id(delta), IntegerLit(3)))), AssignStmt(Id(check), BooleanLit(True)), AssignStmt(Id(check), BooleanLit(False))), WhileStmt(BinExpr(>, Id(n), BinExpr(&&, IntegerLit(3), BinExpr(<, Id(delta), IntegerLit(3)))), BlockStmt([CallStmt(printInteger, Id(n)), AssignStmt(Id(n), BinExpr(-, BinExpr(+, IntegerLit(8), IntegerLit(9)), BinExpr(%, IntegerLit(3), IntegerLit(8)))), AssignStmt(Id(delta), BinExpr(+, Id(delta), IntegerLit(4)))]))]))
])"""
