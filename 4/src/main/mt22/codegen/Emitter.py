...
class Emitter():
    ...
    *   @param toLabel the ending label  of the scope where the variable is active.
    ...
    def emitVAR(self, in_, varName, inType, fromLabel, toLabel, frame): # local vardecl
        # in_: Int   # index of local variable
        # varName: String
        # inType: Type
        # fromLabel: Int
        # toLabel: Int
    ...
    *   @param isFinal true in case of constant; false otherwise
    ...
    def emitATTRIBUTE(self, lexeme, in_, isFinal, value): # global vardecl
        # lexeme: String
        # in_: Type
        # isFinal: Boolean   # constant
        # value: String
